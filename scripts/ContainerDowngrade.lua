---Manages Container Downgrades.
---@param Player LuaPlayer
---@param Container LuaEntity
local function ContainerDowngrade(Player, Container)
	...
	local Target = math.min(table_size(Link) - 1, tonumber(settings.startup["Spacedestructor-TierLimit"].value))
